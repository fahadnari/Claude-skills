...
1. Unzip this file
2. Move the `ab-test-designer` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `ab-test-designer` folder to `~/.claude/skills/`
...
- Structured hypothesis (If/Then/Because)
...
→ [Full documentation](https://mysecond.ai/skills/ab-test-designer)
