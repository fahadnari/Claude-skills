...
> **Not sure which experiment skill to use?**
> Use **A/B Test Designer** when you can randomly split web/app traffic and need statistical significance.
> Use **Experiment Designer** for everything else — pricing changes, feature betas, pilots, fake doors, or any experiment where random assignment isn't possible.
...
After the test concludes, save a summary entry to `specs/outputs/experiment-log.md` using this shared format (also used by the `experiment-designer` skill — keeping both in one log makes it easy to review all experiments together):
...
| **Result** | ✅ Winner / ❌ No effect / ⚠️ Mixed / 🔄 Inconclusive |
...
- [ ] Share learnings with team — failed tests are as valuable as winners
