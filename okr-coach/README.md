...
1. Unzip this file
2. Move the `okr-coach` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `okr-coach` folder to `~/.claude/skills/`
...
- Quality scoring (ambition, measurability, alignment, clarity)
- Common mistake detection
- Concrete rewrite suggestions
- Output-to-outcome translation
- Baseline and target guidance
...
→ [Full documentation](https://mysecond.ai/skills/okr-coach)
