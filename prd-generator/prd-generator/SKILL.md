...
**→ After writing this PRD, run Devil's Advocate**
Use the `devils-advocate` skill to stress-test the PRD before stakeholder review. It surfaces hidden assumptions, failure modes, and blind spots — and gives you the hard questions skeptics will ask. The workflow is:

```
PRD Generator → Devil's Advocate → revise PRD → Devil's Advocate (optional second pass)
```

> "Here's my PRD. Run devil's advocate on it before I present to engineering."
...
5. **Always challenge before presenting** — Run `devils-advocate` on every PRD before a stakeholder review
